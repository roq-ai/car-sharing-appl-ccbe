  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Car Sharing Application - Your gateway to convenient, affordable, and eco-friendly mobility solutions. Join us and experience a new way of commuting!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Sharing Application - Your gateway to convenient, affordable, and eco-friendly mobility solutions. Join us and experience a new way of commuting!`}
            </Text>
            <Box
